...
void lcd_show_chinese(uint16_t x, uint16_t y,  uint8_t no, uint8_t size, uint8_t n, uint8_t mode);
...
void LCD_Show_Image(uint16_t x, uint16_t y, uint16_t width, uint16_t height);                    //display picture
