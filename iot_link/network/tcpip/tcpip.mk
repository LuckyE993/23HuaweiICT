...
ifeq ($(CONFIG_TCPIP_AL_ENABLE), y)
	...
	ifeq ($(CONFIG_M26_ENABLE), y)
        include $(iot_link_root)/network/tcpip/m26/build.mk        
    endif

	ifeq ($(CONFIG_EC600S_ENABLE), y)
        include $(iot_link_root)/network/tcpip/ec600s/build.mk        
    endif
